            ...
            <Row>
                {!_.isNil(state.recipe) ? (
                    <>
                        ...
                        <Col span={24}>
                            <div className={style.additionalInformations}>
                                ...
                                <div className={style.people}>
                                    ...
                                    <span>{state.recipe.personnes === 1 ? "personne"  : "personnes" } </span>
                                </div>
                            </div>
                        ...
                        <Col span={12}>
                            <img className={style.recipeImg} src={state.recipe.photo} alt={state.recipe.description} />
                        </Col>
                        <Col span={12}>
                            ...
                            <div className={style.steps}>
                                ...
                                <ol>
                                    {state.recipe.etapes.map((el, k) => <li>{el}</li>)}
                                </ol>
                            </div>
